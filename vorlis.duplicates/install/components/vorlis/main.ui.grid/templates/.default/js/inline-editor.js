				...
				children: [
							...
							BX.create('button', {
								...
								events: {
									click: function(event)
									{
										...
										var input = layout.querySelector(".main-grid-image-editor-file-input");
					...
					BX.create("input", {
						...
						events: {
							...
							{
								var preview = layout.querySelector(".main-grid-image-editor-preview");
								if (BX.type.isDomNode(preview))
								{
